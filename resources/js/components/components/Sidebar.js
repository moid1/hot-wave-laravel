...
import { faBook, faBoxOpen, faChartPie, faCog, faFileAlt, faHandHoldingUsd, faHistory, faSignOutAlt, faTable, faTimes, faCalendarAlt, faMapPin, faInbox, faRocket, faUserCheck } from "@fortawesome/free-solid-svg-icons";
  ...
  return (
    <>
      ...
      <CSSTransition timeout={300} in={show} classNames="sidebar-transition">
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white side-list`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0 ">
              <NavItem title="Recipe Dashboard" link={Routes.DashboardOverview.path} image={ReactHero} />

              <NavItem title="Weighing Duration" link={Routes.WeighingDuration.path} icon={faChartPie} />
              <NavItem title="Operator Performance" link={Routes.OperatorPerformance.path} badgeText="User" icon={faUserCheck} />

              <NavItem title="Recipe Trend" icon={faHistory} link={Routes.RecipeTrend.path} />
              <NavItem title="Event Summary" icon={faEvernote} link={Routes.EventSummary.path} />
