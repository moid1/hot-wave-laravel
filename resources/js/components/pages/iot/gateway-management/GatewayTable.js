...
export const GatewayTable = (props) => {
    ...
    const TableRow = (props) => {
        const {name, imei, type, created_at, admin} = props;
                ...
                <td className="col-3 col-xl-1 text-center">
                    <span className="icon-dark">
                        <Button className={"btn-success action-btn"}
                            ...
                            icon={faEye}/> View Details</Button>
                        {admin? (
                            <Fragment>
            ...
            <Card.Body className="pt-4">
                <Table hover className="user-table align-items-center">
                    ...
                    <tr>
                        ...
                        <th className="border-bottom text-center bold-font col-2">Action</th>
                    </tr>
                    </thead>
                    <tbody>
