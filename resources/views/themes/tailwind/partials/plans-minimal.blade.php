        ...
        <div class="w-full max-w-md px-0 mx-auto mb-6 lg:w-1/3 lg:mb-0">
            <div class="relative flex flex-col h-full mb-10 bg-white sm:mb-0">
                ...
                <div class="relative">
                    ...
                    <div class="inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold transition duration-150 ease-in-out bg-gray-200 border border-transparent cursor-default text-wave-600 focus:outline-none disabled:opacity-25"
                         disabled>
                        You're subscribed to this plan
                    </div>
                    @notsubscribed
                    @subscriber
                    <div onclick="switchPlans('{{ $plan->plan_id }}', '{{ $plan->name }}')"
...
@if(!auth()->guest())
    <div class="mx-auto max-w-7xl mb-3">
        <div class="w-full p-10 text-gray-600 bg-blue-50">
            <div class="flex items-center pb-4">
                <div class="relative">
                    <h2 class="text-base font-bold text-wave-500">Buy SMSes and Emails</h2>
                    <p class="text-sm text-blue-400">You can buy SMSes and Emails without any subscription plan:</p>
                </div>
            </div>
            <div class="row">
                <div class="col">
                ...
                <div class="col relative mt-3">
                    <div onclick="waveCheckout('{{ config("wave.paddle.sms_product_id") }}', 'smsCheckoutComplete')"
                         class="inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition duration-150 ease-in-out bg-gradient-to-r from-wave-600 to-indigo-500 hover:from-wave-500 hover:to-indigo-400 border border-transparent cursor-pointer focus:outline-none disabled:opacity-25">
                        Try It Now!
                    </div>
                </div>
            </div>
        ...
        <div class="w-full p-10 text-gray-600 bg-blue-50">
            <div class="flex items-center pb-4">
                ...
                <div class="relative">
                    ...
                    <p class="text-sm text-blue-400">Application billing is in sandbox mode, which means you can test
                        the checkout process using the following credentials:</p>
                </div>
            </div>
            <div class="pt-2 text-sm font-bold text-gray-500">
