            ...
            <div class="w-full lg:w-9/12 xl:w-4/5">
                <div>
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <input id="name" type="text" name="name" placeholder="Full Name"  required class="w-full form-control @error('name') is-invalid @enderror" value="{{$user->name}}">
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <input id="email" type="email" name="email" placeholder="Email Address"  required class="w-full form-control @error('email') is-invalid @enderror" value="{{$user->email}}">
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <input id="phone" type="text" name="phone" placeholder="Phone number"  required class="w-full form-control @error('phone') is-invalid @enderror" value="{{$user->phone}}">
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <input id="username" type="text" name="username" placeholder="Username"  required class="w-full form-control  @error('username') is-invalid @enderror" value="{{$user->username}}">
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="hidden" name="mailable"  value="0" />
                                <input class="form-check-input" type="checkbox" role="switch" id="mail" value="1"  name="mailable" {{$user->mailable? 'checked': ''}}/>
                                <label class="form-check-label font-medium leading-5 text-gray-700" for="mail">Send Email Notification</label>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="hidden" name="messagable"  value="0" />
                                <input class="form-check-input" type="checkbox" role="switch" id="sms" name="messagable" value="1" {{$user->messagable? 'checked': ''}}/>
