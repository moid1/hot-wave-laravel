<div class="p-8">
    ...
    @else
        ...
        @else
            <p class="text-gray-600">Please <a href="{{ route('tenancy.settings', ['section'=>'plans', 'tenant'=>tenant('id')]) }}">Subscribe to a Plan</a> in order to see your subscription information.</p>
